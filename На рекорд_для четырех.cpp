...
void Sharik3 (int* x, int* y, int* vx, int* vy, double* v, double* dt, int* Xpr, int* Ypr, int* Xpr1, int* Ypr1, int* Xpr2, int* Ypr2, int* Xpr3, int* Ypr3, int* Xpr4, int* Ypr4);
...
void Sharik3 (int* x, int* y, int* vx, int* vy, double* v, double* dt, int* Xpr, int* Ypr, int* Xpr1, int* Ypr1, int* Xpr2, int* Ypr2, int* Xpr3, int* Ypr3, int* Xpr4, int* Ypr4)
    {
        ...
        *y = *y + *vy * *dt;
        ...
        ogranich (x, y, vx, vy, "Game Over 4!", TX_LIGHTMAGENTA);

        upravlenie (vx, vy, v, '8', '4', '5', '6');

        Pr (TX_LIGHTMAGENTA, "Game Over 4!", x, y, vx, vy, Xpr, Ypr, Xpr1, Ypr1, Xpr2, Ypr2, Xpr3, Ypr3, Xpr4, Ypr4);
    }
void upravlenie (int* vx, int* vy, double* v, COLORREF vverh, COLORREF vlevo, COLORREF vniz, COLORREF vpravo)
    {
