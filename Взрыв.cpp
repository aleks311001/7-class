...
void Razvitie ()
    ...
    while (t <= 70)
        ...
        Buh (560, 260, 1 + 5 * t, 1 + 5 * t, TX_ORANGE, TX_BLACK);
        t += 1;
        txSleep (0);
        txClear ();
        }
    ...
    while (t <= 10)
        {
        dog (475, 730, 1, 0.8, t/4%2 * 5, TX_BLACK, TX_BLACK, TX_BLACK, TX_BLUE, TX_BLACK);
        Derevo (1160, 230, 1.1, 1.1, RGB(100, 255, 33), 1);
        Derevo (1820, 180, 0.8, 0.8, RGB(100, 255, 33), 1);
        chelovek (400, 630, 1, 1, -40, 90, TX_BLACK, TX_GREEN);
        Derevo (1270 , 500, 0.8, 0.8, RGB(100, 255, 33), 1);
        chelovek (450, 300, 1, 1, 30, 80, RGB(255, 200, 0), TX_GREEN);
        t += 1;
        txSleep (0);
        txClear ();
        }
...
void Kradga ()
    ...
    while (t <= 225)
        ...
        //Derevo (-1000 + 4 * t, 180, 1, 1, RGB(100, 255, 33), 1);
        Pushka (2000 - 7 * t, 630, 1, 1, 1, TX_ORANGE, TX_BLUE, TX_GRAY, TX_BLACK);
        dog (475 + 2 * t, 730, 1, 0.8, t/4%2 * 5, TX_BLACK, TX_BLACK, TX_BLACK, TX_BLUE, TX_BLACK);
        ...
        Text ("Человек: Вор! Лови его!", 700, 700 + t, 40, 15, "Arial", false, 0, TX_WHITE);
        Text ("Собака: Тяв-тяв-тяв", 700, 750 + t, 40, 15, "Arial", false, 0, TX_WHITE);
        t += 1;
        txSleep (0);
        txClear ();
        }
...
void Pomosh ()
    ...
    while (t <= 110)
        ...
        dog (925 + 2 * t, 730, 1, 0.8, t/4%2 * 5, TX_BLACK, TX_BLACK, TX_BLACK, TX_BLUE, TX_BLACK);
    ...
    while (t <= 56)
        ...
        dog (1145, 730, 1, 0.8, t/4%2 * 5, TX_BLACK, TX_BLACK, TX_BLACK, TX_BLUE, TX_BLACK);
...
void Smert ()
    ...
    while (t <= 55)
        ...
        Derevo (1040, 500, 1, 1, RGB(100, 255, 33), 1);
        dog (1145 - 2 * t, 730, 1, 0.8, t/4%2 * 5, TX_BLACK, TX_BLACK, TX_BLACK, TX_BLUE, TX_BLACK);
        Derevo (15, 180, 1, 1, RGB(100, 255, 33), 1);
        chelovek (90, 300, 1, 1, -30, 80, RGB(255, 200, 0), TX_GREEN);
