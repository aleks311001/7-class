...
void Sharik (int* x, int* y, int* vx, int* vy, double* v, double* dt, int* Xpr, int* Ypr, int* Xpr1, int* Ypr1, int* Xpr2, int* Ypr2, int* Xpr3, int* Ypr3, int* Xpr4, int* Ypr4)
    {
        ...
        *y = *y + *vy * *dt;
        ...
        Pr (TX_LIGHTGREEN, "Win 1!", x, y, vx, vy, Xpr, Ypr);
        Pr (TX_LIGHTGREEN, "Win 1!", x, y, vx, vy, Xpr1, Ypr1);
        Pr (TX_LIGHTGREEN, "Win 1!", x, y, vx, vy, Xpr2, Ypr2);
        Pr (TX_LIGHTGREEN, "Win 1!", x, y, vx, vy, Xpr3, Ypr3);
        Pr (TX_LIGHTGREEN, "Win 1!", x, y, vx, vy, Xpr4, Ypr4);
    }
...
void Sharik1 (int* x, int* y, int* vx, int* vy, double* v, double* dt, int* Xpr, int* Ypr, int* Xpr1, int* Ypr1, int* Xpr2, int* Ypr2, int* Xpr3, int* Ypr3, int* Xpr4, int* Ypr4)
    {
        ...
        *y = *y + *vy * *dt;
        ...
        ogranich (x, y, vx, vy, "Win 2!", TX_LIGHTRED);

        upravlenie (vx, vy, v, 'W', 'A', 'S', 'D');

        Pr (TX_LIGHTRED, "Win 2!", x, y, vx, vy, Xpr, Ypr);
        Pr (TX_LIGHTRED, "Win 2!", x, y, vx, vy, Xpr1, Ypr1);
        Pr (TX_LIGHTRED, "Win 2!", x, y, vx, vy, Xpr2, Ypr2);
        Pr (TX_LIGHTRED, "Win 2!", x, y, vx, vy, Xpr3, Ypr3);
        Pr (TX_LIGHTRED, "Win 2!", x, y, vx, vy, Xpr4, Ypr4);
    }
