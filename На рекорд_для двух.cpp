...
void Sharik (int* x, int* y, int* vx, int* vy, double* v, double* dt, int r);
...
void Sharik1 (int* x, int* y, int* vx, int* vy, double* v, double* dt, int r);
...
void Sharik (int* x, int* y, int* vx, int* vy, double* v, double* dt, int r)
    ...
    *y = *y + *vy * *dt;
    ...
    ogranich (x, y, vx, vy, "Win 1!", TX_LIGHTGREEN, r);
...
void Sharik1 (int* x, int* y, int* vx, int* vy, double* v, double* dt, int r)
    ...
    *y = *y + *vy * *dt;
    ...
    ogranich (x, y, vx, vy, "Win 2!", TX_LIGHTBLUE, r);
